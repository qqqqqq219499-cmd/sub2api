...
func TestOpenAIGatewayService_ForwardUpstreamTimeoutReturnsFailover(t *testing.T) {
	gin.SetMode(gin.TestMode)
	...
	require.False(t, rec.Code >= http.StatusBadRequest, "未写出响应时应返回 failover 错误，由 handler 决定是否切号")
}
